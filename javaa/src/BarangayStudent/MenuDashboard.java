...
public class MenuDashboard extends JPanel {
	...
	public void menuClicked(JPanel panel) {
		...
		//studentreport.senior();
		//studentreport.elem();
		//studentreport.junior();
		//studentreport.college();
		
		studentreport.allstudent();
		studentreport.AllMale();	
		studentreport.AllFemale();
		studentreport.allActive();
		studentreport.allSports();
		studentreport.info();
		studentreport.search();
		studentreport.alldrop();
		studentreport.allElemLevel();
		studentreport.alljuniorLevel();
		studentreport.allseniorLevel();
		studentreport.allcollegeLevel();
		studentreport.allvocLevel();
